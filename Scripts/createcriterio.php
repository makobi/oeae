...
$output = " <div id='content'>
 	...
 	$output = $output."	<br><br>
 	<input type='submit' value='Create Criterion' class='btn btn-danger'>
 	</form>
 	</center>
 	<br>
 	<br>
